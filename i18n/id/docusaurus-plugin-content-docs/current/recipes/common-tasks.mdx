---
title: 'Resep: Tugas Umum'
description: 'Selesaikan masalah sehari-hari di proyek Flowra dengan resep praktis dan potongan kode.'
---

Resep berikut menjawab pola yang sering diminta. Sesuaikan dengan modul dan service Anda.
...
Ekspos metadata di controller agar klien dapat membangun UI pagination.

## Upload file dengan Express dan S3
...
Registrasikan antrean di container dan proses job pada skrip worker menggunakan binding service container yang sama.
...
Inject service ini ke controller atau middleware untuk mengamankan endpoint eksperimental.

:::tip Bagikan resep
Simpan resep di version control agar tim dapat merujuk dan mengembangkannya. Tambahkan entri baru saat pola baru muncul.
:::
